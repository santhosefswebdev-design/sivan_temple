...
<section class="content">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <select class="form-control search_box" data-live-search="true" data-live-search-style="startsWith" name="ledger[]" id="ledger" multiple data-actions-box="true" data-selected-text-format="count">
								...
								<div class="col-md-12 col-sm-12" style="margin:0px;">                                    
    											<button type="submit" class="btn btn-primary btn-lg waves-effect" id="print">Print</button>
    											<!--<button type="submit" class="btn btn-primary btn-lg waves-effect" id="my_pdf">PDF</button>
    											<label class="btn btn-primary btn-lg waves-effect" id="my_excel">Excel</label>-->
    											<input name="pdf_archanaireport" type="submit" class="btn btn-danger btn-lg waves-effect" id="pdf" value="PDF">
												<label class="btn btn-success btn-lg waves-effect" id="excel">Excel</label>
                                                <?php
                                                $file_name = "General_ledger_".$fdate."_to_".$tdate;
                                                ?>
    ...
    <div class="table-responsive">
        <table class="table1 tableexcel" id="my_table_<?= $ledgerid; ?>" border="1" width="1000" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;" >
            <thead>
                <tr style="padding: 15px 0;">
                    ...
                    <td width="25%" align="left" style="padding: 15px 5px;"><strong>Particulars</strong></td>
                    ...
                    <td width="20%" align="right" style="padding: 15px 5px;"><strong>Balance Amount</strong></td>
                </tr>
            </thead>
            <tbody>
                <tr style="background-color:#F2F2F2;">
                    <td></td><td colspan="3">Opening Balance</td><td></td><td></td><td></td>
...
function downloadCode(){
    var x = document.getElementById("divTableData_general_ledger");  
    generatePDF();
...
$("#excel").click(function(){
    ...
    /*$("#excel").click(function(e) {
        window.open('data:application/vnd.ms-excel,' + encodeURIComponent( $('div[id$=divTableData_general_ledger]').html()));
        e.preventDefault();
    });*/
</script>