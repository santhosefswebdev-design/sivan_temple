                                                ...
                                                <tbody>
                                                    ...
                                                    <?php } else { ?>
                                                        <tr>
                                                            <?php $i = 0; foreach($time_list as $row) { ?>           
                                                                <td>
                                                                    <input style="left: 2%; opacity: 1; position: inherit;" type="radio" id="booking_slot" class="booking_slot" name="booking_slot[]" value="<?php echo $row['id']; ?>">
                                                                    <?php echo $row['slot_name']; ?>
                                                                </td>
                                                            <?php } ?>
                                                        </tr>
                                    ...
                                    <div class="cart">
                                        ...
                                        <form action="" method="post"></form>
                                            <div class="row" style="margin-top: 25px;">
                                                ...
                                                <div class="col-sm-12" style="text-align: left;color: blue;display: none;">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-12" style="text-align: left;color: #f44336;display: none;">
                                                    <div class="form-group">
