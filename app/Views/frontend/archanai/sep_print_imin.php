		...
		$i=1; foreach($booking as $row) 
			...
			if($row['groupname'] == 'VILAKU'){
				...
				<div style="width: 150mm;font-weight: 600;font-family: monospace;"  class="arc">
					...
					<p><img src="<?php echo base_url(); ?>/uploads/main/<?php echo $temp_details['ar_image']; ?>" style="width:200px;" align="center"></p>
					<h1 style="text-align:center; margin:0"><?php echo $temp_details['name']; ?></b></h1>
					...
					<?php if(!empty($row['watermark_image'])) { ?>
						...
						<p style="text-align: left;"><?= $i++; ?>&nbsp;&nbsp;<?= $row['name_eng']; ?><br>&nbsp;&nbsp;
						   <?= $row['name_tamil']; ?><br>&nbsp;&nbsp;
						   <span style="font-size: 32px;">[RM<?= $row['amount']; ?> x <?= $row['quantity']; ?> = RM<?= number_format($row['amount'] * $row['quantity'], 2); ?>]</span></p>
					<?php $row['amount']; ?>
					<hr>
					<p style="text-align: center; font-size: 40px;">Total:  RM<?= number_format($row['amount'] * $row['quantity'], 2); ?></p>
					<?php 
					...
					<p><img src="<?php echo base_url(); ?>/assets/images/wordings.jpg" style="width:385px;" align="center"></p> */ ?>
					<hr>
					<br>
				</div>
				<br><br><br>
				...
				{	 ?>
					...
					<div style="width: 150mm;font-weight: 600;font-family: monospace;"  class="arc">
						...
						<p style="text-align:center;font-size:20px;font-weight:bold;">["PLEASE SCAN HERE"]</p> */ ?>
						<br><br>
						<?php /*n<p  class="dot_line"><span>---</span>GRASP SOFTWARE SOLUTIONS SDN. BHD.<span>---</span></p>
						<p>உங்கள் சேவையும் மற்றும் ஆதரவும் <br> நமது ஆலயத்திற்கும் தமிழ் பள்ளிகளுக்கும் <br> கிடைக்க வேண்டும்</p> 
						<p><img src="<?php echo base_url(); ?>/assets/images/tamil_wordings_new.jpeg" style="width:385px;" align="center"></p> */ ?>
						<hr>
						<br>
					</div>
					<br><br><br>
