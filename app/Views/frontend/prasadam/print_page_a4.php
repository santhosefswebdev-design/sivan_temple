            ...
            <td width="85%" style="padding: 0px; border: 1px solid #000;">
                <table class="table1" style="width: 100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td>
                            <p style="text-align:center; font-size:16px; margin:0;">
                                Reg.No: <?php echo $temp_details['regno']; ?>
                            </p>
                        </td>
                    </tr>
                    <tr>
...
<td style="text-align: center; padding: 10px; border: 1px solid #000;">
    ...
    if (!empty($data['collection_date']) && $data['collection_date'] != '0000-00-00') {
        echo date('d-m-Y', strtotime($data['collection_date']));
    }
    ?>
</td>
    ...
    <td style="text-align: center;  padding: 10px; border: 1px solid #000;">
        Collection Time: <?php echo $data['collection_session']; ?>
    </td>
</tr>
...
<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
    <table class="table table-bordered table-striped table-hover">
        <tbody>
            <tr>
                <td style="text-align: center; font-weight: bold; padding: 10px; border: 1px solid #000;">Description
                </td>
                <td style="text-align: center; font-weight: bold; padding: 10px; border: 1px solid #000;">Quantity</td>
                <td style="text-align: right; font-weight: bold; padding: 10px; border: 1px solid #000;">Unit Price(RM)
                </td>
        ...
        <tbody>
            <?php 
			$discount = !empty($data['discount_amount']) ? (float) $data['discount_amount'] : 0;
			$sub_total = $data['amount'] + $data['discount_amount'];
			...
			<tr>
                ...
                <td style="text-align: right;">
                    <?php
                    // You can replace this with the actual subtotal calculation:
                    // Assuming $data['subtotal'] holds the subtotal amount.
			...
			<tr>
                ...
                <td style="text-align: right;"><?php echo !empty($discount) ? '-' . number_format($discount, 2) : '0.00'; ?></td>
            </tr>
            <tr>
                 <td colspan="3" style="text-align: right; font-weight: bold;">Total(RM)</td>
            ...
            <tr>
                <td colspan="2">
                    <table border="1" style="width:100%" align="center">
                        <tr>
                            <th width="33%" style="text-align:center">Payment Date</th>
                            <th width="33%">Payment Mode</th>
                            <th width="33%" style="text-align:center">Paid Amount(RM)</th>
                            <th width="33%" style="text-align:center">Balance Amount(RM)</th>
...
<table class="details">
  <tr>
      <th>Booked Date</th>		
      <td style="white-space: nowrap;"><?php $date = new DateTime($data['date']);
      echo $date->format('d-m-Y'); ?></td>	
      <th>Collection Date</th>		
      <td style="white-space: nowrap;"><?php $date = new DateTime($data['collection_date']);
      echo $date->format('d-m-Y'); ?></td>	
