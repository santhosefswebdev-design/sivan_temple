                                                ...
                                                <div class="row">
                                                    <div class="col-md-4" style="text-align:left;">
                                                     ...
                                                     <div class="col-md-4" style="text-align:center;">
                                                         <p style="margin-top:10px;">
                                                             <button type="button" class="btn ar_btn1 btn-danger btn-lg" id="delete-button">Delete</button>
                                                        </p>
                                                    </div>
                        ...
                        ({
                            ...
                            success: function (data) {
                                ...
                                if (obj.err != '') {
                                    ...
                                    userDetail.clearUser();
                                    window.open("<?php echo base_url(); ?>/donation_online/payment_process/" + obj.id, "_blank", "width=680,height=500");
