                ...
                <tr>
                    ...
                    <td width="85%" style="padding: 0px; border: 1px solid #000;">
                        <table class="table1" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr>
                                <td>
									<p style="text-align:center; font-size:16px; margin:0;">Temple Reg.No: <?php echo $temp_details['regno']; ?></p>
								</td> 
                            </tr>
                            <tr>
		...
		<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        Date: <?php echo date('d-m-Y h:ia'); ?>
                    </td>
                </tr>
				<tr>
                    <!-- <td style="text-align: center;">
                        Event Date: <?php echo date('d-m-Y', strtotime($data['booking_date'])); ?>
                    </td> -->
                    <td style="text-align: center;">
	...
	<tr>
		<td colspan="2">
			<table border="1" style="width:100%" align="center">
				<tr>
					<th width="18%" style="text-align:center">Payment Date</th>
					<th width="18%">Payment Mode</th>
					<th width="32%" style="text-align:center">Paid Amount(RM)</th>
					<th width="32%" style="text-align:center">Balance Amount(RM)</th>
...
<tr>
        ...
        <td style="font-weight: bold;" align="right">
            <?php echo "Total Paid(RM): " . number_format($paid_amount, '2', '.', ','); ?>
        </td>
        
        <!-- Display the remaining balance -->
        <td style="font-weight: bold;" align="right"><?php echo "Balance Payable(RM): " . number_format($balance_amount, 2, '.', ','); ?></td>
    </tr>
        </table>
    </td>
</tr>
