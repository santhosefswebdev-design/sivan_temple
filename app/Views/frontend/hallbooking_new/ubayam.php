                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb2" value="13" />
                                                                <label for="cb2"><i class="mdi mdi-qrcode"></i><br>QR</label>
                                                            </li>
                                                            <li>
                                                                <input type="radio" name="payment_mode" id="cb3" value="12" />
...
function date_click(event) {
    ...
    if (cur_day < today) {
        // Disable the button if the selected date is before today
        $('#add-button').prop('disabled', true);
    } else {
        // Enable the button for today or future dates
