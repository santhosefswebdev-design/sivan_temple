			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<!-- Popup Modal -->
						...
						<div class="col-md-12">
							<h3 style="text-align: center" >Annathanam Report</h3>
						</div><br>

						<div class="header1">
                            <form action="<?php echo base_url(); ?>/report_online/print_annathanam_report" method="POST">
                                <div class="container-fluid">
                                    ...
                                    <div class="col-md-2 col-sm-4">
                                        ...
                                        <div class="col-md-1 col-sm-2" align="right"> 
                                            <input name="pdf_annathanamreport" type="submit" class="btn btn-danger btn-lg waves-effect" id="pdf_prasadamreport" value="PDF">
                                        </div>
                                        <div class="col-md-1 col-sm-2" align="right"> 
                                            <input name="excel_annathanamreport" type="submit" class="btn btn-success btn-lg waves-effect" id="excel_prasadamreport" value="EXCEL">
                                        </div>
                                ...
                                <table style="width:100%;" align="center" class="table table-striped dataTable" id="datatables">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:5%;">Total Amount(RM)</th>
                                            <th style="width:5%;">Paid Amount(RM)</th>
											<th style="width:15%;">Action</th>
                                            <th style="width:15%;">Admin Action</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<td style="width: 12%;">
												...
												<a class="btn btn-primary btn-rad" href="<?= base_url()?>/annathanam_counter/print_annathanam/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-print"></i> </a>
												<a class="btn btn-danger btn-cancel btn-rad" title="Cancel" data-id="<?php echo $row['id']; ?>"><i class="fa fa-times"></i> </a>	
                                                <?php if($bal_amt && $row['payment_type'] == "partial") { ?>
                                                    <a class="btn btn-warning btn-payment btn-rad" title="Pay" data-id="<?php echo $row['id']; ?>"><i class="fa fa-credit-card"></i></a>	
                                                <?php } ?>
...
<script>
    ...
    $(document).ready(function(){        
        report = $('#datatables').DataTable({
            ...
            paging: false,
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/annathanam_rep_ref",
                dataType: "json",
                type: "POST",
                data: function ( data ) {
                    data.fdt = $('#fdt').val();
