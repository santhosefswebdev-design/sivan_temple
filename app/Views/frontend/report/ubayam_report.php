          ...
          <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<!-- Popup Modal -->
						<div class="col-md-12">
							<h3 style="text-align: center" >Ubayam Report</h3>
						</div><br>
						    ...
						    <form action="<?php echo base_url(); ?>/report_online/print_hallreport_temple" method="POST">
                                <div class="container-fluid">
                                    <div class="row clearfix">
                                        ...
                                        <input type="hidden" name="booking_type" id="booking_type" class="form-control" value="2" >
                                        <input type="hidden" name="report_type" id="report_type" class="form-control" value="2" >
										<div class="col-md-2 col-sm-4">
                                            <div class="form-group form-float">
												<div class="form-line">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 12%;">
                                                        ...
                                                        <a class="btn btn-primary btn-rad" href="<?= base_url()?>/templeubayam_online/print_page_ubayam/<?php echo $row['id'];?>" target="_blank"><i class="fa fa-print"></i> </a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" style="text-align: center;" id="repaymentModalLabel">Ammavasai Repayment</h5>
...
<script>
	$(document).ready(function() {
		$(document).on('click', '.btn-payment', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url(); ?>/templeubayam_online/gtpaymentdata",
				data: {
					id: bookingId
				},
				success: function(response) {
    ...
    $("#saveRepayment").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>/templeubayam_online/save_repayment", 
            data: {
                date: date,
...
(
    ...
    {        
        report = $('#datatables').DataTable({
            ...
            paging: false,
            "ajax":{
                url: "<?php echo base_url(); ?>/report_online/ubayam_rep_ref_temple",
                dataType: "json",
                type: "POST",
                data: function ( data ) {
                    data.fdt = $('#fdt').val();
