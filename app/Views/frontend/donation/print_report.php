...
<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
    <table class="table table-bordered table-striped table-hover">
        <tr>
            <td style="text-align: center; font-weight: bold; padding: 10px; border: 1px solid #000;" width="60%">
        ...
        <tr>
            ...
            <td style="text-align: center;">
                Remarks: <?php echo $data['description']; ?>
            </td>
            <td style="text-align: center;">
...
<div class="table-responsive col-md-12" style="background:#FFF; float:none;margin-bottom:0px;">
    <table class="table table-bordered table-striped table-hover">
        <tbody>
            <tr>
                <td colspan='2'
                    style="text-align: center; font-weight: bold; padding: 10px; border: 1px solid #000; width: 54%">
                    Description</td>
                <td colspan='2'
                    style="text-align: right; font-weight: bold; padding: 10px; border: 1px solid #000; width: 20%">
                    Amount (RM)</td>
            </tr>
        </tbody>
        <tbody>
            <tr>
                <td colspan='2' style="text-align: center;"><?php echo $data['pname']; ?></td>
                <td colspan='2' style="text-align: right;"><?php echo $data['amount']; ?></td>
            </tr>
            <tr>

                <td colspan='2' style="text-align: right"><strong>Total Amount(RM)</strong></td>
