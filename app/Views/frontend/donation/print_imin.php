...
*/ ?>
	...
	<div style="width: 150mm;font-weight: 600;font-family: monospace;" id="booking_tickets">
		<div style="width: 150mm;font-weight: 600;font-family: monospace;" class="booking_ticket">
			...
			<hr>
			<p style="text-align: center; font-size:28px;">Cash Donation Receipt</p>
			<hr>
			<p><b>Date : </b>
				<?php /*$date = new DateTime($qry1['date']);
				echo $date->format('d-m-Y ');*/ ?>
				<?php echo date('d-m-Y h:ia', strtotime($qry1['created'])); ?>
        ...
        <div style="width: 150mm;font-weight: 600;font-family: monospace;" class="booking_ticket">
			...
			Tel: <?= $temp_details['telephone']; ?></p>
			<hr>
			<p style="text-align: center;">Cash Donation Receipt</p>
			<hr>
			<p><b>Date : </b>
					<?php /*$date = new DateTime($qry1['date']);
						  echo $date->format('d-m-Y ');*/ ?>
