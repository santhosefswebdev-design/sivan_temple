...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2><?php echo $lang->member; ?> <?php echo $lang->reg; ?> <small><?php echo $lang->member; ?> / <b><?php echo $lang->member; ?> <?php echo $lang->reg; ?></b></small></h2>
        </div>
        <!-- Basic Examples -->
                    ...
                    <?php if ($permission['create_p'] == 1) { ?>
                        <div class="header">
                            <div class="row">
                                ...
                                <div class="col-md-4" align="right"><a href="<?php echo base_url(); ?>/member/add"><button
                                            type="button" class="btn bg-deep-purple waves-effect"><?php echo $lang->add; ?></button></a></div>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="body">
                                            ...
                                            <?php if ($permission['view'] == 1 || $permission['print'] == 1) { ?>
                                                <td style="width: 16%;">
                                                    <?php if ($permission['view'] == 1) { ?>
                                                        <a class="btn btn-success btn-rad"
                                                            href="<?= base_url() ?>/member/view/<?php echo $row['id']; ?>"><i
                                                                class="material-icons">&#xE417;</i></a>
                                                    <?php }
                                                    if ($permission['print'] == 1) { ?>
                                                        <a class="btn btn-primary btn-rad"
                                                            href="<?= base_url() ?>/member/print_page/<?php echo $row['id']; ?>"
                                                            target="_blank"><i class="material-icons">&#xe8ad;</i></a>
                                                    <?php }
                                                    if ($permission['edit'] == 1 && $row['status'] == 1 ) { ?>
                                                        <a class="btn btn-warning btn-rad"
                                                            href="<?= base_url() ?>/member/edit/<?php echo $row['id']; ?>"><i
                                                                class="material-icons">&#xE3C9;</i></a>
                                                    <?php } ?>
