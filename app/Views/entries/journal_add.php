									...
									<div class="row">
										<div class="col-md-5">
											<div class="form-group">
												...
												<select class="form-control search_box" data-live-search="true" data-live-search-style="startsWith" name="journal_accountname" id="journal_accountname" <?php echo $disabled; ?>>
...
$(document).ready(function(){
	...
	$('#addCreditDebitdetail').click(function(){
		...
		if(account_name != '' && (dramt != "0.00" && dramt != "0" || cramt != "0.00" && cramt != "0")){
			...
			text1 += '<td style="width: 20%;"><input type="number" class="row_totdr" name="entries['+i+'][dramt]" id="totdr_'+i+'" value="'+dramt+'"' + dramt_read + '></td>';
			text1 += '<td style="width: 20%;"><input type="number" class="row_totcr" name="entries['+i+'][cramt]" id="totcr_'+i+'" value="'+cramt+'"' + cramt_read + '></td>';
