...
<table style="width:100%">
	...
	<table border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;width: 100%;max-width: 100%;">
    ...
    $fdate = $pdfdata['fdate'];
    $tdate = $pdfdata['tdate'];
    foreach($pdfdata['ledger_id'] as $ledgerid){
        $ledgername_code = get_ledger_name($ledgerid);
        $res_ledger = loop_general_ledger_statement($ledgerid,$fdate, $tdate);
    ?>
	
	<table class="table1" border="1" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;width: 100%;max-width: 100%;">
			<tr>
				<td colspan="8"><h3 style="text-transform: uppercase;font-size: 18px;margin:15px 0px;text-align:center;"><?php echo $ledgername_code; ?></h3></td>
			</tr>
			<tr style="padding: 15px 0;background-color: #F2F2F2;">
                ...
                <td width="25%" align="left" style=""><strong>Particulars</strong></td>
                ...
                <tr >
                    <td></td><td colspan="3" align="right">Opening Balance</td><td></td><td></td><td></td>
