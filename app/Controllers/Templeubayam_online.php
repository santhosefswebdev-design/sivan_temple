...
class Templeubayam_online extends BaseController
{
	...
	public function ubayam()
	{
		...
		echo view('frontend/layout/header');
		echo view('frontend/templeubayam_new/ubayam', $data);
		//echo view('frontend/layout/footer');
	}
	...
	public function print_page_ubayam_old()
	{
	...
	public function print_page_ubayam_imin()
	{
		...
		$data['package_names'] = $package_names;
		$package_amount = $this->db->table('booked_packages')
			->select('amount') // Assuming 'amount' is the column name for package amount
			->where('booking_id', $id)
			->get()->getRowArray();

		// Pass the package amount to the view
